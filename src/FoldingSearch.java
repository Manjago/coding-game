...
public class FoldingSearch {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < limit; i++) {
            ...
            solver.init(i, sb.toString());
        }
        final String result = FoldingANote.answer(solver);
        System.out.println(result);
        final StringBuilder sb = new StringBuilder();
        for(char c: result.toCharArray()) {
            int[] ints = solver.find(c);
            sb.append(ints[0]);
            sb.append(',');
            sb.append(ints[1]);
            sb.append(',');
